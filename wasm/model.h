...
public:
    ...
    ContrastDualPolicyNet(int blocks=4) : num_res_blocks(blocks) {
        // Init Layers (shapes match export script)
        // Input: 90 -> 64
        conv_input = new Conv2d(90, 64, 3, 1, 1);
    ...
    ~ContrastDualPolicyNet() {
        delete conv_input;
        for (auto b : res_blocks) delete b;
        delete move_conv; delete move_fc;
        delete tile_conv; delete tile_fc;
        delete value_conv; delete value_fc1; delete value_fc2;
    }
